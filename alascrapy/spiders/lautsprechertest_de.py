...
class Lautsprechertest_deSpider(AlaSpider):
    name = 'lautsprechertest_de'
    allowed_domains = ['lautsprechertest.de']
    start_urls = ['https://www.lautsprechertest.de/']

    def __init__(self, *args, **kwargs):
        super(Lautsprechertest_deSpider, self).__init__(self, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        next_page_xpath = "//a[@class='navigate-active']/@href"
    ...
    def parse_items(self, response):
        ...
        review_date = datetime.strptime(date, "%d.%m.%Y")
        ...
        if not review['TestSummary']:
            review['TestSummary'] = self.extract(response.xpath("//div[@class='review_text']/p[1]"))
