...
class BeachcameraComSpider(AlaSpider):
    name = 'beachcamera_com'
    allowed_domains = ['beachcamera.com']
    start_urls = ['http://www.beachcamera.com/']
    ...
    def parse_product(self, response):
        ...
        review_url = 'http://www.beachcamera.com/shop/productreviews.aspx?sku=&pageid=%s&srt=DateNew&lmt=50' % id_match[0]
