...
class Dvbtstick_netSpider(AlaSpider):
    name = 'dvbtstick_net'
    allowed_domains = ['dvbtstick.net']
    start_urls = ['https://www.dvbtstick.net/']

    def __init__(self, *args, **kwargs):
        super(Dvbtstick_netSpider, self).__init__(self, *args, **kwargs)
