...
class Wetterstation_netSpider(AlaSpider):
    name = 'wetterstation_net'
    allowed_domains = ['wetterstation.net']
    start_urls = ['https://www.wetterstation.net/']

    def __init__(self, *args, **kwargs):
        super(Wetterstation_netSpider, self).__init__(self, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        next_page_xpath = "//div[@class='pagination']/a[1]/@href"
