...
class Handyohnevertrag_netSpider(AlaSpider):
    name = 'handyohnevertrag_net'
    allowed_domains = ['handyohnevertrag.net']
    start_urls = ['https://www.handyohnevertrag.net/']

    def __init__(self, *args, **kwargs):
        super(Handyohnevertrag_netSpider, self).__init__(self, *args, **kwargs)
